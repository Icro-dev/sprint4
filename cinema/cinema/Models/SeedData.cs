        ...
        public static async void Initialize(IServiceProvider serviceProvider)
        {
            ...
            if (!context.RoomTemplates.Any())
            {
                context.RoomTemplates.AddRange(
                    new RoomTemplate
                    {
                        Setting = "{ \"0\": 15, \"1\": 15, \"2\": 15, \"3\": 15, \"4\": 15, \"5\": 15, \"6\": 15, \"7\": 15}"
                    },
                    new RoomTemplate
                    {
                        Setting = "{\"0\": 10,\"1\": 10,\"2\": 10,\"3\": 10,\"4\": 10,\"5\": 10}"
                    },
                    new RoomTemplate
                    {
                        Setting = "{\"0\": 10,\"1\": 10,\"2\": 15,\"3\": 15}"
                    }
                );
            }
            ...
            if (!context.Shows.Any())
            {
                context.Shows.AddRange(
                    new Show
                    {
                        ...
                        Break = false,
                        Movie = context.Movies.First(m => m.Name == "Joker")
                   ...
                   new Show
                   {
                       ...
                       Break = false,
                       Movie = context.Movies.First(m => m.Name == "Avatar")
                   },
                  new Show
                  {
                      ThreeD = true,
                      ...
                      Break = false,
                      Movie = context.Movies.First(m => m.Name == "Gravity")
                  },
                   new Show
                   {
                       ThreeD = false,
                       ...
                       Break = false,
                       Movie = context.Movies.First(m => m.Name == "When Harry Met Sally")
                   },
                 new Show
                 {
                     ThreeD = false,
                     ...
                     Break = false,
                     Movie = context.Movies.First(m => m.Name == "The Lord of the Rings: The Fellowship of the Ring")
                   ...
                   new Show
                   {
                       ...
                       Break = false,
                       Movie = context.Movies.First(m => m.Name == "The Dark Knight")
                   }
                    );
            }
